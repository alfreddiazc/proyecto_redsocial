...
public class ImagenDAO {
    ...
    public void Agregar_ImagenVO(ImagenVO vo) {
        Conectar conec = new Conectar();
        String sql = "INSERT INTO imagen (id, nombre, archivo) VALUES(?, ?, ?);";
        PreparedStatement ps = null;
        try {
            ps = conec.getConnection().prepareStatement(sql);
    ...
    public void Modificar_ImagenVO(ImagenVO vo) {
        Conectar conec = new Conectar();
        String sql = "UPDATE imagen SET nombre = ?, archivo = ? WHERE id = ?;";
        PreparedStatement ps = null;
        try {
            ps = conec.getConnection().prepareStatement(sql);
    ...
    public void Modificar_ImagenVO2(ImagenVO vo) {
        Conectar conec = new Conectar();
        String sql = "UPDATE imagen SET nombre = ? WHERE codigo = ?;";
        PreparedStatement ps = null;
        try {
            ps = conec.getConnection().prepareStatement(sql);
            ps.setString(1, vo.getNombreimg());

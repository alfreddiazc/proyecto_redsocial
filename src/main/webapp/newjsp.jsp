...
<html>
    ...
    <body>
        ...
        <h1><%=u.getEmail()%>  Mk ya! </h1>
        <h1><%=u.getApellido()%>  Mk ya! </h1>
        <h1><%=u.getUsuario()%>  Mk ya! </h1>
        <h1><%=u.getUsuario()%>  Mk ya! </h1>
        <h1><%=u.getUsuario()%>  Mk ya! </h1>
        <hr>
        <form action="amista">
            ...
            <input aria-describedby="emailHelp" name="amigo" class="form-control" value="<%=u.getUsuario()%>" placeholder="..." type="hidden">
